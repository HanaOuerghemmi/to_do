...
func NewCmdFlags() *CmdFlags {
	...
	flag.StringVar(&cf.Add, "add", "", "Add a new todo sspecify title")
	...
	flag.BoolVar(&cf.List, "list", false, "Lisst all todoss")
...
func (cf *CmdFlags) Execute(todos *Todos) {
	...
	case cf.Edit != "":
		...
		if len(parts) != 2 {
			fmt.Println("Error, invalid format for edit,  Pleassse use id: new_title")
			os.Exit(1)
		}
